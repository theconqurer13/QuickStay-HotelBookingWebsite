...
const AllRooms = () => {
    ...
    // function to change if a room matches the selected room types
    ...
    },[rooms,selectedFilters,sortOption,searchParams]);
                ...
                <div className='px-5 pt-5'>
                 ...
                 <div className='px-5 pt-5 pb-5'>
                    ...
                    {sortOptions.map((option,index)=>(
                        <RadioButton key={index} label={option} selected = {sortOption === option} onChange={()=>handelSortChange(option)}/>
                    ))}
                </div>
            </div>
        </div>
